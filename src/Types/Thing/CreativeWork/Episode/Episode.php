...
class Episode extends \Vnetby\Schemaorg\Types\Thing\CreativeWork\CreativeWork
{
   const TYPE = 'Episode';
    ...
    * @return static
    */
   function setEpisodeNumber($value)
   {
       return $this->setProp('episodeNumber', $value);
   }
   ...
   {
       return $this->getProp('episodeNumber');
   }
}
